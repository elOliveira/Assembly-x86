...
msgFinal1 db "    Fim do questionario,parabens!!",0
msgFinal2 db "        Projeto produzido por:",0
msgFinal3 db "      PHSP-> Pedro Henrrique Sarnento",0
msgFinal4 db "      ELO -> Eliasjan Luiz de Oliveira",0
msgFinal5 db "      AVOS-> Ana Vitoria Oliveira",0
;---------------------------------------------------------------------alternativa correta-------------------------------------------------------------------------
...
pergunta8 db " Em que ano lancou o primeiro episodio de Avatar a lenda de Aang?", 0
